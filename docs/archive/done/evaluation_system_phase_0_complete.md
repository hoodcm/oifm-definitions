...
- CLAUDE.md now points to `docs/context/agent_evaluation_best_practices_2025.md` as authoritative source
...
**File:** `docs/context/agent_evaluation_best_practices_2025.md`
