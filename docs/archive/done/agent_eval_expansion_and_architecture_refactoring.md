...
- `docs/context/evaluator_architecture_2025.md` - Complete architectural guidance
...
- `docs/context/agent_evaluation_best_practices_2025.md` - References new architecture
...
- `docs/context/evaluator_architecture_2025.md` - Evaluator organization and patterns
- `docs/context/agent_evaluation_best_practices_2025.md` - Eval development best practices
- `docs/context/pydantic_ai_testing_best_practices.md` - AI agent testing guidance
- `docs/context/code_style_conventions.md` - Project code style
