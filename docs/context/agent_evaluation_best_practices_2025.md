...
See `docs/context/evaluator_architecture_2025.md` for complete guidance on where evaluators live and when to use built-in vs. custom evaluators.
...
**See:** `docs/context/evaluator_architecture_2025.md` for decision framework
...
- See: `docs/context/evaluator_architecture_2025.md` for complete details
...
- **Architecture reference:** `docs/context/evaluator_architecture_2025.md`
