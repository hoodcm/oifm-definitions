...
- `docs/context/pytest_fixtures_reference_2025.md` - New fixture documentation
- `docs/context/index_duckdb_migration_status_2025.md` - This status file
- `docs/context/index_duckdb_migration_decisions_2025.md` - Architectural decisions
